...
is( Zonemaster->config->get->{resolver}{defaults}{retry}, 2, 'access other way works too' );
...
is( Zonemaster->config->get->{resolver}{defaults}{retry}, 4711, 'loading config works' );
