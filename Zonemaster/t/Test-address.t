...
%res = map { $_->tag => 1 } Zonemaster->test_module( q{address}, q{address04.zut-root.rd.nic.fr} );
ok( $res{NAMESERVER_IPV6_ADDRESS_BOGON}, q{Nameserver IPv6 addresses is bogon} );
