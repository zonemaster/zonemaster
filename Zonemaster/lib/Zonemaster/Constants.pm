...
our @EXPORT_OK = qw[
  ...
  $ASN_CHECKING_SERVICE_USED
  $ASN_CHECKING_ZONEMASTER_SERVICE_NAME
  $ASN_IPV4_CHECKING_SERVICE_ROUTE_VIEWS_DOMAIN
  $ASN_IPV4_CHECKING_SERVICE_TEAM_CYMRU_DOMAIN
  $ASN_IPV4_CHECKING_SERVICE_ZONEMASTER_DOMAIN
  $ASN_IPV6_CHECKING_SERVICE_ROUTE_VIEWS_DOMAIN
  $ASN_IPV6_CHECKING_SERVICE_TEAM_CYMRU_DOMAIN
  $ASN_IPV6_CHECKING_SERVICE_ZONEMASTER_DOMAIN
  $ASN_UNASSIGNED_UNANNOUNCED_ADDRESS_SPACE_VALUE
...
our %EXPORT_TAGS = (
    ...
    asn => [
        qw($ASN_CHECKING_ROUTE_VIEWS_SERVICE_NAME $ASN_CHECKING_TEAM_CYMRU_SERVICE_NAME $ASN_CHECKING_SERVICE_USED $ASN_CHECKING_ZONEMASTER_SERVICE_NAME $ASN_IPV4_CHECKING_SERVICE_ROUTE_VIEWS_DOMAIN $ASN_IPV4_CHECKING_SERVICE_TEAM_CYMRU_DOMAIN $ASN_IPV4_CHECKING_SERVICE_ZONEMASTER_DOMAIN $ASN_IPV6_CHECKING_SERVICE_ROUTE_VIEWS_DOMAIN $ASN_IPV6_CHECKING_SERVICE_TEAM_CYMRU_DOMAIN $ASN_IPV6_CHECKING_SERVICE_ZONEMASTER_DOMAIN $ASN_UNASSIGNED_UNANNOUNCED_ADDRESS_SPACE_VALUE)
    ],
