...
| mxrdata        | Non-negative integer and domain name, space separated in a text string | Preference and (mail) exchange from MX RDATA ([RFC 1035][RFC1035#section-3.3.9], section 3.3.9).                             |
