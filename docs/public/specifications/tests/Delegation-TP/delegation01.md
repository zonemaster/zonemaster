...
[RFC 10001, Section 4.1] states: “To prevent DNS name space partitioning, at
least two IPv4-reachable and two IPv6-reachable name servers MUST be
configured for a zone. A single name server that is reachable over both IPv4
and IPv6 counts once per address family.”.
