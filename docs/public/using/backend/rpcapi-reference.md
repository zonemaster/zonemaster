...
*Deprecated. To be removed with release v2027.1. To be replaced by
[Hash batch id].*
...
*Deprecated. To be removed with release v2027.1*.
...
*Deprecated. To be removed with release v2027.1* Replaced by
[API method: batch_create](#api-method-batch_create).
...
The use of *[batch id]* is deprecated and will be removed by release v2027.1.
