...
```sh
curl -L -O https://github.com/zonemaster/zonemaster-gui/releases/download/v4.2.0/zonemaster_web_gui.zip
...
```sh
wget https://github.com/zonemaster/zonemaster-gui/releases/download/v4.2.0/zonemaster_web_gui.zip -O zonemaster_web_gui.zip
sudo unzip -d /var/www/html/zonemaster-web-gui zonemaster_web_gui.zip
sudo install -vd /var/log/zonemaster
...
```sh
fetch https://github.com/zonemaster/zonemaster-gui/releases/download/v4.2.0/zonemaster_web_gui.zip
...
server configuration after each updates as those files will be overwritten.
