...
```sh
curl -L -O https://github.com/zonemaster/zonemaster-gui/releases/download/v4.1.0/zonemaster_web_gui.zip
...
```sh
wget https://github.com/zonemaster/zonemaster-gui/releases/download/v4.1.0/zonemaster_web_gui.zip -O zonemaster_web_gui.zip
sudo unzip -d /var/www/html/zonemaster-web-gui zonemaster_web_gui.zip
sudo install -vd /var/log/zonemaster
...
```sh
fetch https://github.com/zonemaster/zonemaster-gui/releases/download/v4.1.0/zonemaster_web_gui.zip
