...
### Messages tag not used (5)

Message Tag                   | Level in profile| Message ID for message tag                                                                                                  | Defined
:-----------------------------|:----------------|:----------------------------------------------------------------------------------------------------------------------------|----------------
FAKE_DELEGATION_IN_ZONE_NO_IP | ERROR           | The fake delegation of domain {domain} includes an in-zone name server {nsname} without mandatory glue (without IP address).| Translator.pm 
FAKE_DELEGATION_NO_IP         | ERROR           | The fake delegation of domain {domain} includes a name server {nsname} that cannot be resolved to any IP address.           | Translator.pm 
NS_FETCHED                    | DEBUG3          | -                                                                                                                           | -
PROFILE_FILE                  | INFO            | -                                                                                                                           | - 
QUERY                         | DEBUG2          | -                                                                                                                           | - 
...
### Has msgid for the tag and consistent arguments (14)
