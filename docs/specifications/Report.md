...
|R08|one nameserver for the domain|[Delegation-TP](Delegation-TP/level.md)|[BASIC02](./Delegation-TP/../Basic-TP/basic02.md)|The domain must have at least one working name server|
...
|R54|nameservers belong all to the same AS|[Connectivity-TP](Connectivity-TP/level.md)|[CONNECTIVITY06](./Connectivity-TP/connectivity06.md)|All IP addresses of the domain's authoritative name server should not be part of same AS|
...
|R74|Answer from name server came from an IP address other than expected (wrong source IP)|[Nameserver-TP](Nameserver-TP/level.md)|[missing](./Nameserver-TP/ns04.md)|          missing|
