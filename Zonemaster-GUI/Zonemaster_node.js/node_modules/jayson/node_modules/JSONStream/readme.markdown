...
## JSONStream.stringify(open, sep, close, indent=0)
...
`indent` is an optional number of spaces to use when indenting the output.
By default `indent` is 0.


## JSONStream.stringifyObject(open, sep, close, indent)
